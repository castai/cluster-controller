...
var _ ActionHandler = &checkNodeStatusPollingHandler{}

type checkNodeStatusPollingHandler struct {
	log       logrus.FieldLogger
	clientset kubernetes.Interface
}

func (h *checkNodeStatusPollingHandler) Handle(ctx context.Context, action *castai.ClusterAction) error {
	if action == nil {
...
func (h *checkNodeStatusPollingHandler) checkNodeDeleted(ctx context.Context, log *logrus.Entry, req *castai.ActionCheckNodeStatus) error {
	timeout := 10
	...
	return waitext.Retry(
		...
		func(ctx context.Context) (bool, error) {
			return checkNodeDeletedPolling(ctx, h.clientset, req.NodeName, req.NodeID, req.ProviderId, log)
		},
		func(err error) {
...
func checkNodeDeletedPolling(ctx context.Context, clientset kubernetes.Interface, nodeName, nodeID, providerID string, log logrus.FieldLogger) (bool, error) {
...
func (h *checkNodeStatusPollingHandler) checkNodeReady(ctx context.Context, _ *logrus.Entry, req *castai.ActionCheckNodeStatus) error {
...
func (h *checkNodeStatusPollingHandler) isNodeReady(node *corev1.Node, castNodeID, providerID string) bool {
