...
func TestApproveCSRHandler(t *testing.T) {
	...
	t.Run("approve v1beta1 csr successfully", func(t *testing.T) {
		...
		client.PrependReactor("*", "*", func(action ktest.Action) (bool, runtime.Object, error) {
	...
	t.Run("approve v1beta1 csr failed", func(t *testing.T) {
		...
		client.PrependReactor("update", "certificatesigningrequests", func(action ktest.Action) (bool, runtime.Object, error) {
			c := csrRes.DeepCopy()
