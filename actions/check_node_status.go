...
func (h *checkNodeStatusHandler) Handle(ctx context.Context, data interface{}, actionID string) error {
	...
	log := h.log.WithFields(logrus.Fields{
		...
		"type":        reflect.TypeOf(data.(*castai.ActionCheckNodeStatus)).String(),
		"id":          actionID,
	})
