...
import (
	...
	types "github.com/castai/cluster-controller/actions/types"
...
func (m *MockClient) AckAction(arg0 context.Context, arg1 string, arg2 *types.AckClusterActionRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) SendAKSInitData(arg0 context.Context, arg1 *types.AKSInitDataRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) SendAKSInitData(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendAKSInitData", reflect.TypeOf((*MockClient)(nil).SendAKSInitData), arg0, arg1)
}
